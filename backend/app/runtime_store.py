    ...
    details = {
        f"{run.id}-report": ArtifactDetail(
            ...
            metadata=[
                ...
                ArtifactMetadataItem(label="design_mode", value=draft.designMode),
                ArtifactMetadataItem(label="reference_source", value=draft.referenceSource),
                ArtifactMetadataItem(label="output_kind", value=draft.outputKind),
                ...
                ArtifactMetadataItem(label="calibration_mode", value=draft.calibrationMode),
                ArtifactMetadataItem(label="runtime_target", value=draft.runtimeTarget),
